...
urlpatterns = [
    ...
    path("contacts_table/", views.contacts_page, name="contacts_page"),  # Страница с таблицей сотрудников
    path("api/get-contacts/", views.api_get_contacts, name="api_get_contacts"),  # API для получения списка работников
    path("api/add-contact/", views.api_add_contact, name="api_add_contacts"),  # API для добавления работника
]