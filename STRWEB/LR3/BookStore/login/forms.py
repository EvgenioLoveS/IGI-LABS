...
class UserCreateForm(UserCreationForm):
    ...
    first_name = forms.CharField(max_length=200, help_text='Enter first name')
    last_name = forms.CharField(max_length=200, help_text='Enter last name')
    date_of_birth = forms.DateField(validators=[validate_age])
    phone_number = forms.CharField(max_length=50, help_text='Enter phone number in format +375 (29) XXX-XX-XX',
